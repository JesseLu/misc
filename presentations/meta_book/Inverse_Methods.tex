...
Additionally, we show that our formulation is general enough 
    to encompass the design of all linear nanophotonic structures 
    and is not limited to the design of optical metamaterials.
While this approach typically produces designs with very high efficiencies 
    (typically 99\%)
    our solutions do feature continuously varying values of the 
    dielectric constant.
...
\bibitem{admm} S. Boyd, N. Parikh, E. Chu, B. Peleato, and J. Eckstein, 
    ...
    Foundations and Trends in Machine Learning, \textbf{3} 1â1122 (2011).
