...
\item however, using $p \in \{\epsilon_1, \epsilon_2\}$ defeats the purpose of using linear approximations
\EIT
\newpage
...
\item implicitly describe boundary using the \emph{level-set} of a higher-dimensional function
\begin{center}
...
\item ...
\begin{center}
\includegraphics[width=0.8\textwidth]{../figures/structure-progression.jpg} \\
\end{center}
\EIT
