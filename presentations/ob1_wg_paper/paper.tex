...
% \section{Conclusion}
% We introduce an objective-first approach to structure design,
%     and apply it to the design of nanophotonic waveguide couplers.
% We show that our method is
%     computationally fast,
%     generates high-efficiency devices with compact footprints,
%     does not require a good starting design, and
%     can be applied to arbitrary waveguide modes.
% 
% 
