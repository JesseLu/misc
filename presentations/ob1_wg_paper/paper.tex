...
In this paper, we present a method to solve the problem 
    of designing linear nanophotonic devices.
...
We now present five results which suggest our method
    is indeed able to design arbitrary linear nanophotonic devices.
...
We then apply this approach to the design of 
    ...
    in small footprints (1-4 square vacuum wavelengths)
