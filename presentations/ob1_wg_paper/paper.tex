...
% For all designs mention
% fast - 20 minutes
All results were obtained in 20 minutes on a single-core personal computer
% subwavelength? all use only 1-4 square vacuum wavelengths
% high performance

% Special mention (arbitrariness)
% breaking symmetry for figs 2, and 3
% fig 3 is not even index guided

% Starting point given just by e = 9
% Mention thresholding efficiencies.
